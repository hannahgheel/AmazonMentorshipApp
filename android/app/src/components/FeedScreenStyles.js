...
export default StyleSheet.create({
  ...
  authorName: { color: colors.textPrimary, fontWeight: 'bold', fontFamily: fonts.heading, fontSize: 22 },
  ...
  caption: { color: colors.textPrimary, fontFamily: fonts.body, fontSize: 18 },
