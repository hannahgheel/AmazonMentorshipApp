...
export default StyleSheet.create({
  ...
  messageBubble: { borderRadius: 12, padding: 10, maxWidth: '80%', marginVertical: 5 },
  myMessageContainer: { alignItems: 'flex-end' },
  theirMessageContainer: { alignItems: 'flex-start' },
  myMessage: { backgroundColor: 'orange' },
  theirMessage: { backgroundColor: '#5B2C6F' },
  messageText: { color: 'white', fontFamily: fonts.body },
  ...
  senderName: { color: colors.textSecondary, fontSize: 12, marginBottom: 4, marginLeft: 10 },
});
